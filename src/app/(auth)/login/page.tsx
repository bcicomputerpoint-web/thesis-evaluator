...
export default function LoginPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#07090F", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: "Inter, sans-serif" }}>
      <div style={{ background: "#111827", border: "1px solid #1C2A3E", borderRadius: 14, padding: 36, width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <div style={{ fontSize: 32, marginBottom: 8 }}>📜</div>
          <h1 style={{ fontSize: 20, fontWeight: 800, color: "#EEF2FF" }}>Sign in to Onusandhan</h1>
          <p style={{ color: "#7C8FA8", fontSize: 13, marginTop: 4 }}>PhD Thesis Evaluator</p>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
          ...
          <span style={{ fontSize: 11, color: "#374558" }}>or</span>
          <div style={{ flex: 1, height: 1, background: "#1C2A3E" }} />
        </div>
        ...
        <form onSubmit={handleEmail}>
          <div style={{ marginBottom: 12 }}>
            <label style={{ fontSize: 11, fontWeight: 700, color: "#374558", textTransform: "uppercase", letterSpacing: 0.8, display: "block", marginBottom: 5 }}>Email</label>
            <input style={inp} type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@university.edu" required />
          </div>
          <div style={{ marginBottom: 20 }}>
            <label style={{ fontSize: 11, fontWeight: 700, color: "#374558", textTransform: "uppercase", letterSpacing: 0.8, display: "block", marginBottom: 5 }}>Password</label>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "#7C8FA8", marginTop: 18 }}>
          ...
          <Link href="/register" style={{ color: "#3B82F6", textDecoration: "none", fontWeight: 600 }}>Register</Link>
        </p>
      </div>
    </main>
  );
